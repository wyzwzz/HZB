...
//            std::cout<<"return nullptr"<<std::endl;
    ...
    do {
        ...
        for (int i = 0; i < h; i++) {
            n_nodes[i].resize(w);
            for (int j = 0; j < w; j++) {
                n_nodes[i][j]= new QuadNode(getNodePtr(i*2,j*2,o_h,o_w),
                                            getNodePtr(i*2,j*2+1,o_h,o_w),
                                            getNodePtr(i*2+1,j*2,o_h,o_w),
                                            getNodePtr(i*2+1,j*2+1,o_h,o_w));
